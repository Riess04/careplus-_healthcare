    ...
    <Form {...form}>
      ...
      >
        <section className="space-y-4">
          <h1 className="header">Hi there, {user.name}👋 </h1>
          <p className="text-dark-700">Let's get to know you.</p>
        </section>
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            name="address"
            label="Address"
            placeholder="602a Moemise Street"
          />
          <CustomFormField
            control={form.control}
            fieldType={FormFieldType.INPUT}
        ...
        <div className=" flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="prostate cancer, diabetes"
          />
          <CustomFormField
            control={form.control}
            fieldType={FormFieldType.TEXTAREA}
